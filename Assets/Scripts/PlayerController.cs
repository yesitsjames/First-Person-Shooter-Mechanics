...
public class PlayerController : MonoBehaviour
{
    ...
    [System.NonSerialized] public bool isPlanting = false;
    ...
    void HandleMovement()
    {
        ...
        isPlanting = Input.GetKey(KeyCode.E);
        ...
        if (inputVector.z != 0 || inputVector.x != 0)
        {
            ...
            if (isPlanting && hasBomb)
            {
                hasBomb = false;
                Instantiate(bomb,playerGroundTransform.position,Quaternion.identity);
            }
        }
        else
        {
